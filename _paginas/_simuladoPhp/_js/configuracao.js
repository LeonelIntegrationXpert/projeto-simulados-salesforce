        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="../../_simuladoJava/_official_training_test/index.html">Simulado Java</a></li>
                <li><a class="dropdown-item" href="../../_simuladoPhp/_official_training_test/index.html">Simulado PHP</a></li>
                <li><a class="dropdown-item" href="../../_simuladoJavaScript/_official_training_test/index.html">Simulado JavaScript</a></li>
                <li><a class="dropdown-item" href="../../_simuladoNodeJs/_official_training_test/index.html">Simulado Node.js</a></li>
                <li><a class="dropdown-item" href="../../_simuladoBancoDeDados/_official_training_test/index.html">Simulado Banco de Dados Relacional SQL</a></li>
              </ul>
            </li>
          </ul>
        </div>
